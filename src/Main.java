public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees[1] = new Employee("Egorova Lidiia Mikhailovna", "accountant", "account@mail.ru", "+79104444444", 10000, 42);
        employees[2] = new Employee("Ivanova Mariia Sergeevna", "administrator", "admin@mail.ru", "+79101111111", 50000.65, 32);
        employees[3] = new Employee("Matrosova Irina Leonidovna", "waiter", "waiter@mail.ru", "+7966666666", 40000.0, 5);
        employees[4] = new Employee("Rusakov Dmitrii Nikolaevich", "chef", "chef@mail.ru", "+7999999999", 90000.8, 41);

        employees[1].setSalary(50000);
        employees[3].setAge(50);

        findOlderThan40(employees);
    }

    public static void findOlderThan40(Employee[] employees){
